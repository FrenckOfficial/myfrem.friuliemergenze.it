  ...
  try {
    ...
    const response = await fetch("https://api.brevo.com/v3/smtp/email", {
      ...
      body: JSON.stringify({
        ...
        subject: `${photoName}: Foto caricata correttamente!`,
        htmlContent,
        replyTo: { 
          name: "Friuli Emergenze",
...
function generateMailHtml({ name, email, photoName, uploadedAt }) {
  return `
<!DOCTYPE html>
<html lang="it">
<head>
...
<div class="container">
  ...
  <div class="content">
    ...
    <div class="info-box">
      <div class="label">Stato della foto</div>
      <div class="value"><b>In attesa di approvazione</b></div>
    </div>

    <div class="info-box">
      <div class="label">Foto caricata in data:</div>
